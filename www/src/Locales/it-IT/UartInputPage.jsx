export default {
  ...
  "autoHandshakeEnabledLabel": "Auto‑discovery attivata",
  "autoHandshakeDisabledLabel": "Auto‑discovery disattivata",
  "autoHandshakeDescription": "Se attivata, l'handshake UART e la negoziazione della velocità di trasmissione si avviano automaticamente in caso di prima configurazione o modifica dei pin o della velocità. Se disattivata, viene utilizzata la configurazione manuale.",
  "pinSelectPlaceholder": "Seleziona pin",
  "enableMapping": "Abilita mappatura pin",
  "mappingEnabled": "Mappatura abilitata",
  "mappingDisabled": "Mappatura disabilitata",
